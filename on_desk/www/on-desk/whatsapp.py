...
from frappe.utils import get_gravatar, get_datetime, pretty_date
...
def get_context(context):
    ...
    context.active_conversation = context.conversations[0] if context.conversations else None
    
    # Get messages for active conversation
    context.messages = get_whatsapp_messages(context.active_conversation.get("phone") if context.active_conversation else None)
...
def get_whatsapp_conversations():
    ...
    for phone in phone_numbers:
        ...
        conversations.append({
            ...
            "phone": phone.phone,
            "image": contact_image,
            "last_message": latest_message[0].message[:50] + "..." if len(latest_message[0].message) > 50 else latest_message[0].message,
